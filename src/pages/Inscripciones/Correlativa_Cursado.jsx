...
import { correlatividadCursado } from "../../helpers/data"

export const Correlativa_Cursado = () => {
    return (
        <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            
            <TitleCursadoConFecha title={'Correlatividad para Cursar de Sichi, Facundo'} />
            ...
            <div className="mt-6 max-w-5xl mx-auto">
                ...
                <div className="overflow-x-auto rounded-2xl mt-3">
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            {correlatividadCursado.map(item => (
