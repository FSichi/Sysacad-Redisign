...
import { materiasExamen } from "../../helpers/data"

export const Inscripcion_Examen = () => {
    return (
        <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">

            <TitleCursadoConFecha title={'Materias que puede inscribirse a examen Sichi, Facundo'} />
                        ...
                        <tbody>
                            {materiasExamen.map(item => (
                                <tr className="border-b bg-gray-900 border-gray-700 text-gray-100" key={item.id}>
                                    ...
                                    <td className="py-5 px-9">
                                        {item.codigo}
                                    </td>
                                    <td className="py-5 px-11 text-blue-400">
                                        <Link to={`/inscripciones/examen/${item.id}`}>Inscribirse</Link>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
